...
left_hand_ids = [61, 62, 63, 64, 65, 66]
...
async def wave_sequence(kos: KOS) -> None:
    ...
    actuator_ids = [21, 22, 23, 24, 25, 11, 12, 13, 14, 15, 31, 32, 33, 34, 35, 41, 42, 43, 44, 45]
    ...
    #     move_to_target(kos, 0.0, -80.0, ACCEL, V_MAX, dt, 22),  # shoulder roll up
    #     move_to_target(kos, 0.0, -60.0, ACCEL, V_MAX, dt, 21),  # shoulder pitch up

    #     move_to_target(kos, 0.0, -15.0, ACCEL, V_MAX, dt, 23),
    #     move_to_target(kos, 0.0, 140.0, ACCEL, V_MAX, dt, 24)
    # )
    ...
    #     move_to_target(kos, -80.0, -5.0, ACCEL, V_MAX, dt, 22),
